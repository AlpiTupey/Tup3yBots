...
const instagram = 'https://instagram.com/AlpiTupey09' ; 
const telegram = 'https://t.me/AlpiTupey09'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Tup3yBots_id';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:AlpiTupey09`)
})
